...
st.title("Alson School - Personal Assitant")
st.divider()
...
if 'generated' not in st.session_state:
    st.session_state['generated'] = ["Hello ! I am your Personal assistant built by Alson International School"]
...
with request_container:
    with st.form(key='xyz_form', clear_on_submit=True):
        ...
        user_input = st.text_input("Prompt:", placeholder="Message AlsonBot...", key='input')
